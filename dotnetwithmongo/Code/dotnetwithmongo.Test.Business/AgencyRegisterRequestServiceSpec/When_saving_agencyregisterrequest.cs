...
{
    public class When_saving_agencyregisterrequest : UsingAgencyRegisterRequestServiceSpec
    {
        ...
        public override void Context()
        {
            ...
            _agencyregisterrequestRepository.Save(_agencyregisterrequest).Returns(true);
        }
        ...
        {
            _agencyregisterrequestRepository.Received(1).Save(_agencyregisterrequest);
