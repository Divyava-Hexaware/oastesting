...
using dotnetwithmongo.Api.Filters;
using dotnetwithmongo.BusinessServices.Installer;

namespace dotnetwithmongo.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetwithmongo API", Version = version + "-" + branch});
            });
