using dotnetwithmongo.Api.Installer;
using dotnetwithmongo.Api.Middleware;
using ElmahCore.Mvc;
...
using System;
using dotnetwithmongo.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace dotnetwithmongo.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "dotnetwithmongo V1");
        });
